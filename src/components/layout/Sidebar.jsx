...
export default function Sidebar({ open = false, onClose = () => {} }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 h-full w-64 bg-navy-800 border-r border-navy-500/30 flex flex-col z-50 transform transition-transform duration-300 lg:translate-x-0 lg:z-30 ${
